...
The reference for writing and editing The Console's text. Every card and page should be
...
Simple, direct, concise. Explains what the deck is and nothing more. No manual conceit, no
mysticism, no jokes. Short declarative sentences. Natural contractions are fine.

> A divination deck of twelve cards. Each card pairs a piece of technology with a part of being
> human, and offers it back as a question about your situation.

### System Documentation (card) — straight

A brief, factual description of the technology, one to three sentences. It plays it completely
straight. It is the setup, not the punchline. Present tense, no contractions, no humor.

> Radar detects objects by sending out radio waves and reading the echoes that return. Because it
...
When an em-dash currently joins two parts, choose the structure that fits:

- **Split into two sentences** when it joined two complete thoughts.
- **A comma** for a light aside or appositive.
- **A colon** when the second part defines or expands the first.
- **Recast** with that, which, and, or but.

Examples, from the about page:

- "…the moment you're in. **It helps you notice** the kind of pattern you're in." *(period)*
