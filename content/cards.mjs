...
export const cards = [
    ...
    },
    {
        ...
        reflection: 'A patch is a small, localized change that fixes a specific problem without altering the underlying structure. The symptom goes away and the system runs again. Patches buy time, but they accumulate, and a system covered in patches becomes harder to understand and harder to repair properly. The time a patch buys can be used to design a proper fix.',
    },
    {
        id: 20,
        name: 'Fork',
