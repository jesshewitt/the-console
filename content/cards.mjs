...
export const cards = [
    ...
    },
    {
        id: 9,
        name: 'Race Condition',
        brief: 'Two things you care about both need you at this moment.',
        tech: 'A race condition is when two operations run at the same time and the outcome depends on which finishes first. Without coordination, the result is unpredictable.',
        situation: 'Two demands arriving at the same time.',
        examples: [
            'A work deadline and a family event on the same day',
            'Two close friends needing your attention',
            'A health appointment and a major work commitment overlapping',
            'A creative project and a paid commitment competing for hours',
            "A personal need and someone else's urgent request arriving together",
        ],
        reflection: 'If you had to pick one to go first, which would it be? What does that choice show you about what matters most right now?',
    },
    {
        id: 10,
        name: 'Cache Miss',
        brief: "You looked for something in its usual place, but it wasn't there.",
        tech: 'A cache miss is when a program looks for data in the cache and comes up empty. The program then has to look at the original source to retrieve it.',
        situation: "Not finding what you're looking for.",
        examples: [
            'Losing your car keys, phone, or wallet',
            "Visiting someone, but they're no longer at that address",
        ],
        reflection: 'What if what you want lives somewhere other than where you have been looking? What might be true about where it actually is?',
    },
    {
        id: 11,
        name: 'Echo',
    ...
    },
    {
        id: 13,
        name: 'Ping',
        brief: 'Reaching out just to see if someone is there.',
        tech: 'A ping is a short message sent to check whether another system is responding. It is a minimal exchange, just a request and a reply.',
        situation: 'A small action to test for presence.',
        examples: [
            'Texting an old friend just to say hi',
            'Liking something a former colleague posted',
            'Asking a casual question to feel out where someone is at',
            'Sending a brief check-in to a family member',
            "Leaving a small comment on someone's post",
            "Saying hi to a neighbor you haven't talked to in a while",
            'Reaching out with a low-stakes message to test the waters with someone',
        ],
        reflection: 'What are you actually checking for? What would a response, or its absence, tell you?',
    },
    {
        id: 14,
        name: 'Throttled',
