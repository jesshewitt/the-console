...
class About {
    ...
    static render() {
        return html`
            <h2>What this is</h2>
            <p>A 24-card oracle deck. Each card names a recognizable life situation through a tech metaphor and offers
            ...
            <p>You cast a card by entering a seed string. Any string works: a word, a phrase, a timestamp. The seed
            deterministically selects one of 24 cards. The same seed always produces the same card, so readings are
            reproducible and shareable. The URL is the reading.</p>
            ...
            <p>Whether the casting picked the matching card through some mechanism or whether you're finding resonance
            ...
            <p>The 24 card names are drawn from the signal, networking, and systems register. The entries were written
            specifically for this project.</p>
            <p>The code is MIT-licensed. The content (the 24 card entries) is dedicated to the public domain under
